...
func change_tile_cell(tilepos, tile_idx):
	set_cell(tilepos.x, tilepos.y, 0)

func local_world_to_map(position_node):
	return world_to_map(to_local(position_node))
